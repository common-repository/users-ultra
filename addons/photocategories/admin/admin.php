...
class UsersUltraPhotoCate {
	...
	function admin_init() 
	{
		...
		$this->tabs = array(
			'manage' => __('Manage Photo Categories','users-ultra')
	...
	function add_menu()
	{
		add_submenu_page( 'userultra', __('Photo Categories','users-ultra'), __('Photo Categories','users-ultra'), 'manage_options', 'uultra-photocategory', array(&$this, 'admin_page') );
	...
	?>
		...
		<div class="wrap <?php echo $this->slug; ?>-admin">
           ...
           <h2>USERS ULTRA PRO -  <?php _e('PHOTO CATEGORY','users-ultra'); ?></h2>
