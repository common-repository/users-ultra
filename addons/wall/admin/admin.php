...
class UsersUltraWall {
	...
	function admin_init() 
	{
		...
		$this->tabs = array(
			'manage' => __('Site-Wide Activity Wall','users-ultra')
	...
	function add_menu()
	{
		add_submenu_page( 'userultra', __('Activity Wall','users-ultra'), __('Activity Wall','users-ultra'), 'manage_options', 'uultra-wall', array(&$this, 'admin_page') );
	...
	?>
		...
		<div class="wrap <?php echo $this->slug; ?>-admin">
           ...
           <h2>USERS ULTRA PRO - <?php _e('SITE-WIDE ACTIVITY WALL MANAGEMENT', 'users-ultra')?></h2>
