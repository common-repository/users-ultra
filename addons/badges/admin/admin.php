...
class uultra_dg_admin {
	...
	function admin_init() {
		...
		$this->tabs = array(
			'manage' => __('Medallion Fulfillment/Assignment','users-ultra'),
			'achievement' => __('View/Edit Fulfillment Medallions','users-ultra'),
			'user_badges' => __('Manage Assigned Medallions','users-ultra'),
		);
	...
	function add_menu() {
		add_submenu_page( 'userultra', __('Medallions and Fulfillments','users-ultra'), __('Medallions and Fulfillments','users-ultra'), 'manage_options', 'userultra-badges', array(&$this, 'admin_page') );
	}
	...
	?>
		...
		<div class="wrap <?php echo $this->slug; ?>-admin">
			 ...
			 <h2>USERS ULTRA PRO - <?php _e('MEDALLIONS AND FULFILLMENTS ','users-ultra')?></h2>
