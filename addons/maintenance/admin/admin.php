...
class UsersUltraMaintenance {
	...
	function admin_init() 
	{
		...
		$this->tabs = array(
			'manage' => __('Maintenance','users-ultra')
	...
	function add_menu()
	{
		add_submenu_page( 'userultra', __('Maintenance','users-ultra'), __('Maintenance','users-ultra'), 'manage_options', 'uultra-maintenance', array(&$this, 'admin_page') );
	...
	?>
		...
		<div class="wrap <?php echo $this->slug; ?>-admin">
           ...
           <h2>USERS ULTRA PRO - <?php _e('MAINTENANCE','users-ultra')?></h2>
