<?php
global $uultra_group, $xoouserultra;
...
if($group_id!=''){
	...
	<form action="" method="post" id="uultra-userslist">
          ...
          <h3><?php _e('Edit Group ','users-ultra'); ?></h3>
           ...
           <p>
            <a href="?page=uultra-groups&tab=manage" class="button button-secondary "   ><i class="uultra-icon-plus"></i>&nbsp;&nbsp;<?php _e('Back','users-ultra'); ?>
</a>
...
<form action="" method="post" id="uultra-userslist">
    ...
    <h3><?php _e('Add New Group ','users-ultra'); ?></h3>
           ...
           <table width="100%" class="wp-list-table widefat fixed posts table-generic">
            <thead>
                <tr>
                    ...
                    <th width="24%"><?php _e('Visibility', 'users-ultra'); ?></th>
                     <th width="19%"><?php _e('Users', 'users-ultra'); ?></th>
                    <th width="13%">&nbsp;</th>
                    <th width="8%">&nbsp;</th>
			...
			?>
                ...
                <tr  id="uu-edit-cate-row-<?php echo $c->group_id; ?>">
                    ...
                    <td>&nbsp;</td>
                     <td>&nbsp;</td>
                   <td> <a href="#" class="button button-secondary user-ultra-btn-red uultra-group-del"  id="" data-gal="<?php echo $c->group_id; ?>"><i class="uultra-icon-plus"></i>&nbsp;&nbsp;<?php _e('Delete','users-ultra'); ?>
                   </a>  <a href="?page=uultra-groups&tab=manage&group_id=<?php echo $c->group_id; ?>" class="button button-secondary "  id="" data-gal="<?php echo $c->group_id; ?>"><i class="uultra-icon-plus"></i>&nbsp;&nbsp;<?php _e('Edit','users-ultra'); ?>
</a> </td>
                </tr>
			...
			?>
			<p><?php _e('There are no groups yet.','users-ultra'); ?></p>
			<?php	} ?>
