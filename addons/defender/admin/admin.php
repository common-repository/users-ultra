...
class UsersUltraIpDefender {
	...
	function admin_init() 
	{
		...
		$this->tabs = array(
			'manage' => __('I.P. Defender','users-ultra')
	...
	function add_menu()
	{
		add_submenu_page( 'userultra', __('I.P. Defender','users-ultra'), __('I.P. Defender','users-ultra'), 'manage_options', 'uultra-ipdefender', array(&$this, 'admin_page') );
