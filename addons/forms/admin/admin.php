...
class UsersUltraForm {
	...
	function admin_init() 
	{
		...
		$this->tabs = array(
			'manage' => __('Manage Forms','users-ultra')
	...
	function add_menu()
	{
		add_submenu_page( 'userultra', __('Forms Ultra','users-ultra'), __('Forms Ultra','users-ultra'), 'manage_options', 'uultra-forms', array(&$this, 'admin_page') );
	...
	public function save()
	{
		...
		if(isset($_POST['form_name'])  && $_POST['form_name']!="")
		{
			...
			echo '<div class="updated"><p><strong>'.__('New form has been created.','users-ultra').'</strong></p></div>';
		}else{
			
			echo '<div class="error"><p><strong>'.__('Please input a name for the new form.','users-ultra').'</strong></p></div>';
	...
	?>
		...
		<div class="wrap <?php echo $this->slug; ?>-admin">
           ...
           <h2>USERS ULTRA PRO - <?php _e('REGISTRATION FORMS','users-ultra'); ?></h2>
