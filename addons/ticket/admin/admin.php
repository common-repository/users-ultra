...
class UsersUltraTicketing{
	...
	function admin_init() 
	{
		...
		$this->tabs = array(
			'manage' => __('Tickets','users-ultra'),
			'send' => __('New Ticket','users-ultra')
	...
	function set_ticket_status() 
	{
		...
		$this->ticket_status = array(
			'open' => __('Open','users-ultra'),
			'pending' => __('Pending','users-ultra'),
			'solved' => __('Solved', 'users-ultra'),
			'closed' => __('Closed','users-ultra'),
			'unassigned' => __('Unassigned','users-ultra')
	...
	function get_status_box($selected=null)
	{
		...
		$html .= '  <option value="">'.__('--- Select Status','users-ultra').'</option>';
	...
	function add_menu()
	{
		add_submenu_page( 'userultra', __('Tickets Ultra','users-ultra'), __('Tickets Ultra','users-ultra'), 'manage_options', 'userultra-tickets', array(&$this, 'admin_page') );
