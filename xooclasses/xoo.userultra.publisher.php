...
class XooPublisher
{
		...
		if($user_id >0)
		{
			...
			if($post_id >0)
			{
				...
				if($this->uultra_is_this_my_post($post_id))
				{
					...
					$this->act_message = __('The post has been deleted!','users-ultra');
	...
	function edit_post($id)		
	{
		...
		if ( !empty( $res ) )
		{
			...
			$this->errors = __('Invalid '.$this->mPostLabelSingular.'', 'users-ultra');
		...
		$can_edit = $this->uultra_can_be_edited();
         ...
         <div class="commons-panel xoousersultra-shadow-borers" >
                  ...
                  <div class="commons-panel-heading">
                             <h2> <?php echo  __('Edit '.$this->mPostLabelSingular.'','users-ultra');?> </h2>
            ...
            <div class="commons-panel-content" >  
				 ...
				 if($can_edit=='no')
				 {
					  echo "<div class='uupublic-ultra-error'>".__("You can't edit this ".$this->mPostLabelSingular."", 'users-ultra')."</div>";
                ...
                <p><a class="uultra-btn-commm" href="?module=posts" title="<?php echo __('Back','users-ultra')?>" ><span><i class="fa fa-angle-double-left  fa-lg"></i></span> <?php echo __('Back','users-ultra')?> </a></p>
					                    
                                        
				</div>
                 
                     <div class="field_row">
                         <p><?php echo __('Title:','users-ultra')?></p>
                     ...
                     <div class="field_row">
                       <p><?php echo __('Category:','users-ultra')?></p>
                ...
                ?>
                 ...
                 <?php }?>
                  ...
                  <div class="field_row">
                 <p><?php echo __(''.$this->mPostLabelSingular.' Photos:','users-ultra')?></p>
                 </div>
				 ...
				 if($can_edit!='no')
				 {
                  ...
                  <p><?php echo __('Description:','users-ultra')?></p>
                ...
                ?>
                   ...
                   <div class="field_row">
                     <p><?php echo __('Tags:','users-ultra')?></p>
	...
	function get_all_post_types()		
	{
		...
		$html .= '<label>
		<input type="checkbox" name="uultra_all_post_types[]" value="page" id="uultra_all_post_types" '.$selected_page.' />'.__('page','users-ultra').'</label>
		<br />';
		$html .= '<label>
		<input type="checkbox" name="uultra_all_post_types[]" value="post" id="uultra_all_post_types" '.$selected_post.' />'.__('post','users-ultra').'</label>
		<br />';
	...
	function show_front_publisher($atts)		
	{
		...
		$user_post_count = $this->count_user_posts_by_type( $user_id , $post_type);		
         ...
         <div class="commons-panel xoousersultra-shadow-borers" >
                  ...
                  <div class="commons-panel-heading">
                             <h2> <?php echo  __('Add New '.$this->mPostLabelSingular.'','users-ultra');?> </h2>
            ...
            <div class="commons-panel-content" >  
                 ...
                 <div class='uupublic-ultra-info'><?php echo  __('Max Allowed '.$this->mPostLabelPlural.': ','users-ultra');?> <?php echo $max_allowed_posts?>, <?php echo  __('You have posted: '.$user_post_count.' already ','users-ultra');?></div> 
	...
	function show_my_posts()
	{
		...
		echo '<div class="tablenav_post">
                ...
                <p><a class="uultra-btn-commm" href="?module=posts&act=add" title="'. __('Add New '.$this->mPostLabelSingular.'','users-ultra').'" ><span><i class="fa fa-plus  fa-lg"></i></span> '.__('Add New '.$this->mPostLabelSingular.'','users-ultra').' </a></p>
					...
					<tbody>
						...
						<tr>
                            ...
                            <?php if($can_be_edited!='no'){?>
                             <a href="?module=posts&act=edit&post_id=<?php echo $post_id ; ?>" title="<?php echo __('Edit','users-ultra')?>" ><span><i class="fa fa-pencil-square-o fa-lg"></i></span> </a>
                               ...
                               <?php }else{?>
                                 ...
                                 <p><?php echo __("Access Denied",'users-ultra')?></p>
                            ...
                            <a href="#"  title="<?php echo __('Delete','users-ultra')?>" class="uultra-del-user-postlink" data-id="<?php echo $post_id ; ?>" ><span><i class="fa fa-times fa-lg"></i></span> </a>
	...
	function uultra_edit_attachment( $post_id )
	{
		...
		if ( $attach ) 
		{
			...
			foreach ($attach as $a) 
			{
				...
				$html .= '<a class="uultra-btn-delpostimg  uu-photopost-delete" href="#" id="" data-id="'. $attach_id.'" ><span><i class="fa fa-times"></i>'.__("Delete Image", 'users-ultra').'</span></a>';
				
				if($attach_id==$post_thumbnail_id)
				{					
					$html .= '<a class="uultra-btn-post-featured-image  " href="#" id="" data-id="'. $attach_id.'" ><span><i class="fa fa-check-square-o "></i>'.__("Main Image", 'users-ultra').'</span></a>';
				
				}else{
					
					$html .= '<a class="uultra-btn-delpostimg  uu-photopost-set-as-main" href="#" id="" data-id="'. $attach_id.'" ><span><i class="fa fa-image "></i>'.__("Set As Main", 'users-ultra').'</span></a>';
				}				
	...
	function edit_conf_post()
	{
       ...
       $post_update = array(
        ...
        if ( $post_id )
		{
		   ...
		   $this->act_message= __('Updated successfully.', 'users-ultra') ;
	...
	function submit_post()
	{
       global $wpdb, $xoouserultra;
		...
		if(!$this->check_if_reached_limit()){
			...
			$this->act_limits= __('You cannot add more '.$this->mPostLabelSingular.' ', 'users-ultra') ;
        ...
        if ( $post_id  &&  $this->act_message=="" &&  $this->act_limits=="")
		{
		   ...
		   {			   
			   $this->act_message= __('Success! The submission will be reviewed soon.', 'users-ultra') ;
		   
		   }else{
			   
			   $this->act_message= __('Post published successfully.', 'users-ultra') ;
				...
				<div id="plupload-upload-ui-postphoto" class="hide-if-no-js">
					...
					<div id="drag-drop-area-postphoto">
						<div class="drag-drop-inside">
							...
							<p class="drag-drop-info"><?php	_e('Drop Images Here', 'users-ultra') ; ?></p>
                            <div style="display:">
							<p><?php _ex('or', 'Uploader: Drop files here - or - Select Files'); ?></p>
							<p class="drag-drop-buttons"><input id="plupload-browse-button-postphoto" type="button" value="<?php _e('Select Files', 'users-ultra') ; ?>" class="button" /></p>
								</div>						
						</div>
