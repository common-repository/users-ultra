...
class XooUserPhoto {
	...
	public function show_photo_grid($atts)
	{
		...
		if($display_search_box=="yes")
		{
			...
			$html.=' <input type="text" name="usersultra_searchphoto" id="usersultra_searchphoto" value="'. get_query_var('searchphoto').'" placeholder="'. __('Search images...','users-ultra').'" />';
			
			 
			
			$html.=' <button type="submit" class="" title="'. __('Search','users-ultra').'">'.__('Search','users-ultra').'</button>';
		...
		{	
			...
			//get categories			
			 $html.='<p> '. __('Filter by category: ','users-ultra').''.$this->get_photo_category_check().'</p>';
		...
		{
			$html .="<h1>".__('Total found: ','users-ultra'). $total_items. "</h1>";
...
?>
				...
				<div id="plupload-upload-ui" class="hide-if-no-js">
					...
					<div id="drag-drop-area-gallery">
						<div class="drag-drop-inside">
							<p class="drag-drop-info"><?php	_e('Drop files here', 'users-ultra') ; ?></p>
							<p><?php _ex('or', 'Uploader: Drop files here - or - Select Files'); ?></p>
							                            
                                                      
                            <p><button id="plupload-browse-button-photogallery">  <?php _e('Select Files', 'users-ultra'); ?></button></p>
		...
		<?php
			...
			$plupload_init = array(
				...
				'filters'             => array(array('title' => __('Allowed Files', 'users-ultra'), 'extensions' => "jpg,png,gif,bmp,jpeg")),
				'multipart'           => true,
