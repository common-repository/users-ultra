        ...
        if($this->load_captcha == true)
        {
            ...
            if(method_exists($this, $method_name))
            {
                ...
                else
                {
					...
					if($form_text == ''){
                        $form_text = __('Human Check','users-ultra');}
					...
					if($heading_text == ''){
                        $heading_text = __("Prove you're not a robot",'users-ultra');}
    ...
    */
    ...
    private function load_recaptcha()
    {
        ...
        if($public_key != '')
        {
            ...
            if($recaptcha_theme == 'users-ultra')
            {
        ...
        return '<div id="recaptcha_widget">
                        <div id="recaptcha_image_holder">
                            ...
                            <div class="recaptcha_text_box">
                                <input type="text" id="recaptcha_response_field" name="recaptcha_response_field" class="text" placeholder=" '.__("Enter Verification Words",'users-ultra').'" />
                            </div>
                        </div>
                        <div id="recaptcha_control_holder">
                            <a href="javascript:Recaptcha.switch_type(\'image\');" title="'.__("Load Image",'users-ultra').'"><i class="fa fa-camera"></i></a>
                            <a href="javascript:Recaptcha.switch_type(\'audio\');" title="'.__("Load Audio",'users-ultra').'"><i class="fa fa-volume-up"></i></a>
                            <a href="javascript:void(0);" id="recaptcha_reload_btn" onclick="Recaptcha.reload();" title="'.__("Refresh Image",'users-ultra').'"><i class="fa fa-refresh"></i></a>
                        </div> 
                </div>
