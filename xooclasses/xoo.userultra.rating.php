		...
		if(!$rate_itself)
		{
			...
			if (is_user_logged_in() || $guest_allowed==1) 
			{
				if($check_vote) 
				{
					...
					$html = __("Thank you for your rating",'users-ultra');
				
				}else{
					
					
					$html = __("You've already left your rate ",'users-ultra');			
				   ...
				   //user is not logged in
					...
					$html = __("You have to be logged in to leave your rate  ",'users-ultra');			
			   ...
			   //is trying to rate itlsef				   
     			$html = __("You cannot rate yourself  ",'users-ultra');			
	...
	public function get_rating($id, $data_target) 
	{
		global $wpdb;
		  ...
		  <ul class="uultra-star-rating" >	
					...
					<li><a href="#" title=" '.__("1 star out of 5 ",'users-ultra').'" class="one-star rating-s" data-id="'.$id.'" data-vote="1" data-target="'.$data_target.'">1</a></li>					
					<li><a href="#" title=" '.__("2 star out of 5 ",'users-ultra').' " class="two-stars rating-s" data-id="'.$id.'" data-vote="2" data-target="'.$data_target.'">2</a></li>
					<li><a href="#" title="'.__("3 star out of 5 ",'users-ultra').'" class="three-stars rating-s" data-id="'.$id.'" data-vote="3" data-target="'.$data_target.'">3</a></li>
					<li><a href="#" title="'.__("4 star out of 5 ",'users-ultra').'" class="four-stars rating-s" data-id="'.$id.'" data-vote="4" data-target="'.$data_target.'">4</a></li>
					<li><a href="#" title="'.__("5 star out of 5 ",'users-ultra').'" class="five-stars rating-s" data-id="'.$id.'" data-vote="5" data-target="'.$data_target.'">5</a></li>
				</ul>
				<p> '.__("Rating: ",'users-ultra').'  '.$rating1.'/10 </p>
				';
