...
class XooBbPress
{
	...
	function show_my_topics_in_profile($user_id, $type, $from=null, $howmany=null)
	{
		...
		while ( $loop->have_posts() ) : $loop->the_post();
			...
			$html .='<p><span class="uultra-post-date"> <i class="fa fa-calendar "></i>'.date("m/d/Y",strtotime($loop->post->post_date)).'</span>  <span class="uultra-post-comments"><i class="fa fa-comment-o "></i>'.$comment_count->approved .'</span> <span class="uultra-post-see"> <i class="fa fa-eye "> <a href="'.$permalink.'">'.__("read more",'users-ultra').' </a></i></span></p>';
			$html .='</div>';
			
			//info
			$html .='<div class="uultra-my-topic-info">';
			$html .='<ul class="topicstats">';
			$html .='<li class="stattopic"><i class="fa fa-eye "> '.__("Views",'users-ultra').'</i><p>'.$total_replies.'</p></li>';
			$html .='<li  class="stattopic"><i class="fa fa-eye "> '.__("Voices",'users-ultra').'</i><p>'.$total_replies.'</p></li>';
			$html .='<li  class="stattopic"><i class="fa  fa-comment-o "> '.__("Replies",'users-ultra').'</i><p>'.$total_replies.'</p></li>';
			$html .='</ul>';
			$html .='</div>';
