...
class XooBadge
{
	...
	function uultra_get_badge($badge,$user_id=null, $tooltip=null) 
	{
		...
		switch($badge){
			...
			case 'online':
				return '<img class="uultra-profile-badge uultra-profile-badge-'.$badge.' uultra-hide-from-list" src="'.$xoouserultra->badges_url.'online.png" alt="" title="'.__('User is online :)','users-ultra').'" />';
				break;
			
			case 'offline':
				return '<img class="uultra-profile-badge uultra-profile-badge-'.$badge.' uultra-hide-from-list" src="'.$xoouserultra->badges_url.'offline.png" alt="" title="'.__('User is offline :(','users-ultra').'" />';
				break;
