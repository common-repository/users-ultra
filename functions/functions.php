				...
				<span class="list-controls hide-if-no-js">
					...
					<span class="hide-if-js" id="help-login-links"><br /><a name="help-login-links"></a>
						<?php
							...
							_e( '&#9725; You can add a redirection page after the user\'s login/logout simply adding a relative link after the link\'s keyword, example <code>#uultraloginout#index.php</code>.','users-ultra');
							
							_e( '<br />&#9725; You can also add <code>%actualpage%</code> to redirect the user on the actual visited page, example : <code>#uultraloginout#%actualpage%</code>.','users-ultra');
...
function uultran_nav_menu_type_label( $menu_item )
{
	...
	{
		$menu_item->type_label = ( __('Login','users-ultra') );
	}
...
function uultra_call_custom_login()
{
...
add_action('init', 'uultra_call_custom_login');
