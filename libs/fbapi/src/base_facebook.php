...
//  print_r($server_info);
   ...
   //echo "all valid 1 CODE ". $server_info['code'];
   
 // echo "alll state value:" . $server_info['state'];
  
 // echo "THIS STATE: " . $this->state;
   ...
   if ($this->state !== null && isset($server_info['state']) && $this->state === $server_info['state']) {
		...
		// echo "all valid22 ". $server_info['code'];
		 ...
		 //  echo "all INVALID ". $server_info['code'];
