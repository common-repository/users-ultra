...
<div class="commons-panel xoousersultra-shadow-borers" >
        ...
        <div class="uu-right">
         ...
         <div class="uu-options-bar">
             ...
             <a class="uultra-btn-email" href="#" id="uu-send-private-message" data-id="<?php echo $user_id?>"><span><i class="fa fa-envelope-o"></i></span><?php echo _e("Send Message", 'users-ultra')?></a>
       ...
       <?php if($photos_available){?>       
        ...
        <?php if($display_gallery){
			...
			?>
              ...
              <h3><a href="<?php echo $xoouserultra->userpanel->get_user_profile_permalink( $user_id);?>"><?php echo _e("Main", 'users-ultra')?></a>  / <?php echo $current_gal->gallery_name?></h3>
        ...
        <?php if($display_photo)
		{
            ...
            <?php if( $current_gal->gallery_name!="" && $photo_id > 0){
			 ...
			 ?>
               ...
               <h3><a href="<?php echo $xoouserultra->userpanel->get_user_profile_permalink( $user_id);?>"><?php echo _e("Main", 'users-ultra')?></a> /  <a href="<?php echo $xoouserultra->userpanel->public_profile_get_album_link( $current_gal->gallery_id, $user_id);?>"><?php echo $current_gal->gallery_name?></a></h3>
        ...
        <?php }?>
         ...
         <div class="photolist">
             ...
             <h2><?php echo _e("My Photo Galleries", 'users-ultra')?></h2>
           ...
           <ul>
             ...
             <?php if(!in_array("videos",$modules)){?> 
                 ...
                 <div class="videolist">
                  ...
                  <h2><?php echo _e("My Videos", 'users-ultra')?></h2>
          ...
          <?php }?>
           ...
           <?php }else{?>           
                 ...
                 <?php echo _e("Photos available only for registered users", 'users-ultra');?>           
