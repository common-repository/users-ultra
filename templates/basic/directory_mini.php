...
<div class="usersultra-front-directory-wrap">
	...
	<div class="usersultra-searcher">
         ...
         <input type="text" name="usersultra_searchuser" id="usersultra_searchuser" value="<?php echo get_query_var('searchuser'); ?>" placeholder="<?php echo _e('Search for a user...','users-ultra'); ?>" />
		 
         <button type="submit" class="" title="<?php echo _e('Search','users-ultra'); ?>"><?php echo _e('Search','users-ultra'); ?></button>
