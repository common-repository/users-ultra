...
<div class="uultra-prof-cont" <?php echo  $main_cont_style?> >
	...
	<div class="uultra-inner" <?php echo  $main_cont_style?>>
		...
		<?php }elseif(isset($_GET['my_galleries']) ){ ?>
			 ...
			 <!------ Galleries 3 ----->
           	<div class="photolist">
			<h2><?php _e("My Photo Galleries", 'users-ultra')?> </h2>
			<ul>
		...
		<?php }elseif(isset($_GET['gal_id']) && $_GET['gal_id']>0){
			...
			<?php _e("Main", 'users-ultra')?></a>  / <?php echo $current_gal->gallery_name?> </div>
		...
		<?php }elseif(isset($_GET['my_followers']) ){ ?>
			...
			<div class="my-follow">
                <h2><?php _e("Followers ", 'users-ultra')?> </h2>
                <ul>
	   ...
	   <?php  }elseif(isset($_GET['my_videos']) ){ ?>
		...
		<?php  }elseif(isset($_GET['my_following']) ){ ?>
			...
			<!------ Following ----->			
			<div class="my-follow">
                <h2><?php _e("Following ", 'users-ultra')?> </h2>
                <ul>
		...
		<?php }elseif(isset($_GET['my_posts']) ){ ?>
			...
			<!------ My Posts ----->		
			<div class="my-posts">
                <h2><?php _e("My Posts ", 'users-ultra')?> </h2>
                <ul>
		...
		<?php }elseif(isset($_GET['my_topics']) ){ ?>
			...
			<!------ My Topics ----->		
			<div class="my-topics">
                <h2><?php _e("Forum Topics I've Started ", 'users-ultra');?> </h2>
                <ul>
