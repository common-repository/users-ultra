...
?>
        ...
        <h3><?php _e('Search Users','users-ultra'); ?></h3>
         
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td width="16%"><?php _e('Keywords:','users-ultra'); ?></td>
             <td width="18%"><?php _e('Membership:','users-ultra'); ?></td>
             <td width="18%"><?php _e('Status:','users-ultra'); ?></td>
             <td width="19%"><?php _e('Custom Meta:','users-ultra'); ?></td>
             <td width="29%">&nbsp;</td>
             <td width="6%">&nbsp;</td>
           </tr>
           <tr>
             <td><input type="text" name="uultra_combined_search" id="uultra_combined_search" placeholder="<?php _e('write some text here ...','users-ultra'); ?>" style="width:100px"/></td>
             <td><select name="uultra_membership" id="uultra_membership">
               <option value="">
                 <?php _e('All Membership','users-ultra'); ?>
               </option>
               <?php
             ...
             <td> <select name="status" id="status">
               <option value="" <?php if($status =="" ) echo 'selected="selected"';?>><?php _e('All','users-ultra'); ?></option>
               <option value="active" <?php if("active"==$status ) echo 'selected="selected"';?>><?php _e('Active','users-ultra'); ?></option>
               <option value="pending" <?php if("pending"==$status ) echo 'selected="selected"';?>><?php _e('Pending Confirmation','users-ultra'); ?></option>
               <option value="pending_admin" <?php if("pending_admin"==$status ) echo 'selected="selected"';?>> <?php _e('Pending Admin','users-ultra'); ?></option>
               <option value="pending_payment" <?php if("pending_payment"==$status ) echo 'selected="selected"';?>> <?php _e('Pending Payment','users-ultra'); ?></option>
          ...
          </select>  <button><?php _e('Filter','users-ultra'); ?></button>
          ...
          <div class="usersultra-paginate top_display"><h3><?php echo $users['total']; ?> <?php _e(' Users ','users-ultra'); ?></h3></div>
		...
		<?php } ?>
           ...
           <table width="100%" class="wp-list-table widefat fixed posts table-generic">
            <thead>
                <tr>
                    <th width="6%"><?php _e('ID', 'users-ultra'); ?></th>
                    <th width="7%"><?php _e('Avatar', 'users-ultra'); ?></th>
                    <th width="11%"><?php _e('IP', 'users-ultra'); ?></th>
                     <th width="11%"><?php _e('Role', 'users-ultra'); ?></th>
                    <th width="18%"><?php _e('Nick', 'users-ultra'); ?></th>
                    <th width="16%"><?php _e('Name', 'users-ultra'); ?></th>
                     <th width="15%"><?php _e('User Email', 'users-ultra'); ?></th>
                     <th width="9%"><?php _e('Status', 'users-ultra'); ?></th>
                    <th width="9%"><?php _e('Registered', 'users-ultra'); ?></th>
                    <th width="9%"><?php _e('Last Login', 'users-ultra'); ?></th>
                    <th width="9%"><?php _e('Actions', 'users-ultra'); ?></th>
                </tr>
            </thead>
			...
			?>
			<p><?php _e('There are no users yet.','users-ultra'); ?></p>
			<?php	} ?>
...
<script>
var message_users_module_delete= "<?php echo _e('Are you really sure that you want to delete this user?','users-ultra')?>"
</script>
