...
jQuery(document).ready(function($) {
	...
	jQuery( ".xoouserultra-datepicker" ).datepicker({changeMonth:true,changeYear:true,yearRange:"1940:2030"});
   ...
   // jQuery('#bup-staff-details').on('click','.bup-widgets-icon-close-open, .bup-staff-details-header',function(e){
    ...
    jQuery(document).on("click", ".uultra-add-new-package", function(e) {
		e.preventDefault();
    ...
    jQuery(document).on("click", ".uultra-links-add-new", function(e) {
		e.preventDefault();		
	...
	//jQuery('.uultra-links-add-new-confirm').live('click',function(e){
     ...
     jQuery(document).on("click", ".uultra-links-add-new-confirm", function(e) {
		e.preventDefault();		
	...
	jQuery(document).on("click", "#uu-edit-order-conf", function(e) {	
		...
		jQuery.ajax({
						type: 'POST',
						url: ajaxurl,
						data: {"action": "uultra_update_order_status", "order_id":order_id,  "order_status":order_status ,  "transaction_id":transaction_id
						},
    ...
    jQuery(document).on("click", "#uultra-pro-remove-30-message", function(e) {	
		...
		jQuery.ajax({
						type: 'POST',
						url: ajaxurl,
						data: {"action": "uultra_remove_30_message"
						},
						
						success: function(data){
							
							jQuery(".uultra-message-yellow-30").slideUp();						
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-links-add-new-close',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-widgets-add-new',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-widgets-add-new-close',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-widgets-add-new-confirm',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-close-new-package',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-btn-edit-field',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','#uultra-duplicate-form-btn',function(e){
		e.preventDefault();				
    ...
    jQuery('#userultra-admin-contain').on('click','#uultra-restore-fields-btn',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','#uultradmin-reset-modules-setting',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','#uultradmin-remove-custom-user-avatar-image',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','#uultradmin-remove-custom-user-bg-image',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-delete-custom-link',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-delete-custom-widget',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-links-edit-content-btn',function(e){     
		e.preventDefault();
		var link_id =  jQuery(this).attr("uultra-linkid");	
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-links-edit-content-btn-membership',function(e){    
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-links-icon-close-open, .uultra-links-close-open-link',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-user-editions-icon-close-open, .uultra-heading-user-edition',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-widgets-icon-close-open, .uultra-expandable-panel-heading-widgets',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-btn-close-edition-field',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','#uultra-add-field-btn',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','#uultra-close-add-field-btn',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-delete-profile-field-btn',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-btn-submit-field',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('change','.uultra_show_to_user_role_edit',function(e){
    ...
    jQuery('#userultra-admin-contain').on('change','.uultra_edit_by_user_role_edit',function(e){
	...
	//jQuery('').live('click',function(e){
     ...
     jQuery('#userultra-admin-contain').on('click','#uultra-btn-add-field-submit',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','#uultra-btn-sync-btn',function(e){
    ...
    jQuery('#userultra-admin-contain').on('change','#uultra__custom_registration_form',function(e){
		e.preventDefault();
		uultra_reload_custom_fields_set();
    ...
    jQuery('#userultra-admin-contain').on('click','#uultra-btn-upgrade-features-btn',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-package-edit',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-package-deactivate',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-add-new-package-confirm',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','#uultradmin-create-upload-folder',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-edit-package-confirm',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-profile-customizer-save-style',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-widget-customizer-save',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-widget-customizer-save-membership',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultradmin-user-approve',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultradmin-user-approve-2',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultradmin-user-deny',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','#uultradmin-confirm-rearrange',function(e){
		e.preventDefault();
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-user-edit-package',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','.uultra-user-see-details',function(e){
    ...
    jQuery('#userultra-admin-contain').on('click','#uultra-delete-csv-export-file',function(e){
		e.preventDefault();		
    ...
    jQuery('#userultra-admin-contain').on('click','#uultradmin-btn-validate-copy',function(e){
		e.preventDefault();
		...
		jQuery.ajax({
						...
						success: function(data){
							...
							jQuery("#loading-animation").slideUp();							
								...
								setTimeout("hidde_noti('uultra-validation-results')", 6000)
   ...
   // jQuery('#userultra-admin-contain').on('click','#uultradmin-create-basic-fields',function(e){
    jQuery(document).on("click", "#uultradmin-create-basic-fields", function(e) {
